...
import com.learning.jhipster.repository.PostRepository;
...
/**
 * REST controller for managing {@link com.learning.jhipster.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
    ...
    private static final String ENTITY_NAME = "demoPost";
    ...
    public ResponseEntity<Post> createPost(@Valid @RequestBody Post post) throws URISyntaxException {
        ...
        Optional<User> user = userService.findOne(post.getUserId());
        user.ifPresent(value -> {
            value.setUserPost(post);
